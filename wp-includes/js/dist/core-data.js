...
${err.toString()}`);
  ...
  // packages/sync/build-module/providers/https-polling/polling-manager.mjs
  ...
  // packages/sync/build-module/providers/https-polling/config.mjs
  ...
  // packages/sync/build-module/providers/https-polling/types.mjs
  ...
  // packages/sync/build-module/providers/https-polling/utils.mjs
  ...
  // packages/sync/build-module/providers/https-polling/https-polling-provider.mjs
  ...
  var fetchUrlData = async (url, options = {}) => {
    ...
    if (!protocol || !(0, import_url5.isValidProtocol)(protocol) || !protocol.startsWith("https") || !/^https?:\/\/[^\/\s]/i.test(url)) {
      return Promise.reject(
        `${url} does not have a valid protocol. URLs must be "https" based`
      );
    }
    if (CACHE.has(url)) {
