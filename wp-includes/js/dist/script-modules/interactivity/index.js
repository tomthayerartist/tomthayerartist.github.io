...
function N(n3, l6, u5, t5, i6) {
  ...
  n: if ("style" == l6) if ("string" == typeof u5) n3.style.cssText = u5;
    ...
    if ("https://www.w3.org/2000/svg" == i6) l6 = l6.replace(/xlink(H|:h)/, "h").replace(/sName$/, "s");
...
function G(u5, t5, i6, r5, o4, e4, f5, c5, s6) {
  ...
  if ("svg" == x3 ? o4 = "https://www.w3.org/2000/svg" : "math" == x3 ? o4 = "https://www.w3.org/1998/Math/MathML" : o4 || (o4 = "https://www.w3.org/1999/xhtml"), null != e4) {
  ...
  if (null == x3) m4 === k3 || c5 && u5.data == k3 || (u5.data = k3);
    ...
    else if (p6 && (u5.innerHTML = ""), L("template" == t5.type ? u5.content : u5, g(v6) ? v6 : [v6], t5, i6, r5, "foreignObject" == x3 ? "https://www.w3.org/1999/xhtml" : o4, e4, f5, e4 ? e4[0] : i6.__k && $(i6, 0), c5, s6), null != e4) for (a5 = e4.length; a5--; ) b(e4[a5]);
