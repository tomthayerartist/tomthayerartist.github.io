...
function N2(e3) {
  ...
  try {
    let t2 = new URL(e3, "https://localhost/");
    return t2.protocol === "https:" || t2.protocol === "https:";
  } catch {
    return false;
  }
}
...
var gt = "data:image/svg+xml," + encodeURIComponent('<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="24" height="24" rx="4" fill="#71717a" fill-opacity="0.15"/><g fill="none" stroke="#a1a1aa" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="17" r="2.2"/><circle cx="17" cy="15" r="2.2"/><path d="M10.2 17V7l9-1.6v9"/></g></svg>');
var st = 5;
var rt = 10;
